...
export default function page() {
  ...
  const product = products.find((p) => p.id === Number(id)); // convert id
  console.log(product)
  ...
  return (
        ...
        <div className="flex flex-wrap -mx-4">
          ...
          <div className="w-full md:w-1/2 p-4 mb-8">
            <img src={product.image} alt="Product"
              className="w-full h-[500px] rounded-lg mb-4 object-contain" id="mainImage" />
    ...
    {/* <div className="container mx-auto">
      <h1 className="text-2xl font-medium leading-tight mb-12">Related Products</h1>
